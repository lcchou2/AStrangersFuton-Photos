...
class Flag extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="flag" onClick={this.showModal}>
          {/* <img className="flag" style={{display: this.state.display}} onClick={this.showModal} src="http://download.seaicons.com/icons/icons8/ios7/512/Very-Basic-Flag-icon.png"/> */}
          <svg viewBox="0 0 24 24" role="img" aria-label="Report" focusable="false" className="flag">
        ...
        <div className="modal-container" style={{display: this.state.display}}>
          <img className="modal" src="https://s3-us-west-1.amazonaws.com/fec-futon/Flag+modal.png"></img>
        </div>
        <button style={{display: this.state.display}} className="closeBtn" onClick={this.hideModal}></button>
      </div>
    );
  }
}
