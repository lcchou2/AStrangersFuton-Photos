...
class Flag extends React.Component {
  ...
  render() {
    return (
      <div>
        <div className="rev-flag" onClick={this.showModal}>
          <svg viewBox="0 0 24 24" role="img" aria-label="Report" focusable="false" className="rev-flag">
        ...
        <div className="rev-modal-container" style={{display: this.state.display}}>
          <img className="rev-modal" src="https://s3-us-west-1.amazonaws.com/fec-futon/Flag+modal.png"></img>
        </div>
        <button style={{display: this.state.display}} className="rev-closeBtn" onClick={this.hideModal}></button>
      </div>
    );
  }
}
